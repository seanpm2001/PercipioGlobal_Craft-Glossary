...
<template>
    ...
    >
        <div class="md:order-2 md:col-span-2 lg:col-span-1 mb-4 bg-gray-200 rounded-lg p-5">
            ...
            <h3 class="pt-3">Term variants</h3>
            ...
            <label class="mb-5 block">
                ...
                <div :class="[
                    ...
                    >
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="fill-current w-full h-full mt-px"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z"/></svg>
                        </span>
                    </span>
                    <input
                        type="text"
