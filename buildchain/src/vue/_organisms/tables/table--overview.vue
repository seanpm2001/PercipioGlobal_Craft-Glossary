...
const getDeleteUrl = (id) => {
    return `${ window.api.url }${ window.api.cp }/glossary/delete?id=${ id }`
}
...
<template>
    <section>
        ...
        <div v-if="loading" class="bg-gray-50/50 absolute inset-0 w-full h-full flex items-center justify-center z-10">
            <svg
